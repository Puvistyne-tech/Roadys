...
export default {
	...
	Mutation: {
		createBook: async (parent, { data }, { prisma }, info) => prisma.book.create({
      data: {
        ...data,
        pages: {
          create: data.pages
    ...
    updateBook: (parent, args, { prisma }, info) => prisma.book.update({
      where: {
        id: args.id
      },
      data: {
    ...
    deleteBook: (parent, args, { prisma }, info) => prisma.book.delete({
      where: {
        id: args.id
      },
      include: {pages: true}
